...
const NavigationBar = () => {
    ...
    const handleClick = () => {
        ...
        *check if the click event target is outside both the mobile menu and the menu icon. If it is, we close the menu by setting isMobileMenuOpen to false */}
    ...
    return (
        <header className='padding-x py-8 absolute z-10 w-full'>
            <nav className='flex justify-between items-center max-container'>
                ...
                <div 
                    ref={menuIconRef}
                    className='hidden max-lg:block rounded-full p-2 hover:bg-gray-200 transition-colors duration-200 cursor-pointer' 
                    id='MenuBar' 
                    onClick={handleClick} 
